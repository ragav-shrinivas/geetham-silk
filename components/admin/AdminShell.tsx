...
import {
  ...
  ShoppingCart, Users, GalleryHorizontalEnd, MessageSquare, Megaphone
} from 'lucide-react'
...
const NAV = [
  ...
  { label: 'Announcements', href: '/evo9-admin/announcements', icon: Megaphone },
  { label: 'Banners', href: '/evo9-admin/banners', icon: GalleryHorizontalEnd },
...
Geethams <span className="text-[var(--brand-darkpink)]">Silks</span>
          </span>
