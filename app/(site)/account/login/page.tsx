  ...
  return (
    <div className="min-h-screen bg-[var(--brand-cream)] pb-24 lg:pb-0">
      <div className="max-w-md mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <PageNav fallback="/" backLabel="Home" crumbs={[{ label: 'Account', href: '/account' }, { label: 'Sign In' }]} className="mb-10" />
        <div className="text-center mb-8">
          <p className="text-xs tracking-[0.35em] uppercase text-[var(--brand-rose)] mb-3">Welcome Back</p>
          <h1 className="font-serif text-4xl font-light text-[var(--brand-charcoal)]">Sign In</h1>
        </div>
