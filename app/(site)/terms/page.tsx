  ...
  return (
    <div className="pt-24 min-h-screen bg-[var(--brand-cream)]">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-20 prose prose-sm prose-gray">
        ...
        <p>Geetham Silks operates as a WhatsApp Commerce platform. This website is for product browsing and enquiry purposes only. No online transactions or payments are processed through this site.</p>
        ...
        <p>All content on this website including images, text, and logos are the property of Geetham Silks and may not be reproduced without written permission.</p>
